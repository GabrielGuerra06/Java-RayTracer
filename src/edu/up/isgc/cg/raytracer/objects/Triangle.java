...
/**
 * Triangle implements our class IIntersectable to get the collitions in the objects by calculating the normal of the objects
 * It receives as properties the vertices of our triangles
...
public class Triangle implements IIntersectable {
    ...
    /**
     * We apply the barycentric formulas to get the intersection depending on the normal
     */
    @Override
