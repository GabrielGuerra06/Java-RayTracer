...
/**
 * Model 3D helps to create our own polygons by arrays of triangles, it extends from Object3D to generate the new objects
 * As parameters we receive the position, our array of triangles, color, material and the vectors to scale and rotate our objects
...
public class Model3D extends Object3D {
    ...
    public Model3D(Vector3D position, Triangle[] triangles, Color color, Materials material, Vector3D scale, Vector3D rotate) {
...
/**
 * getIntersection receives the ray where compars if theres collition, if it is, gets the normal of the object and returns the intersection method, indicating that it collited with himself
 */
    @Override
